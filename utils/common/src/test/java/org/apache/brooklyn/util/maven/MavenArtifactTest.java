...
public class MavenArtifactTest {
    ...
    final static String THIS_PROJECT_COORDINATE = "org.apache.brooklyn:brooklyn-utils-common:jar:0.11.0-20170314.1743";  // BROOKLYN_VERSION
    ...
    public void testRetrievalHostedSnapshotIntegration() throws Exception {
        MavenArtifact m = MavenArtifact.fromCoordinate(
                "org.apache.brooklyn:brooklyn-utils-common:jar:0.11.0-20170314.1743");  // BROOKLYN_VERSION
