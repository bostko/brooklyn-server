...
import org.apache.catalina.javax.servlet.GenericFilter;
 ...
 *
 */
// Copied from org.apache.tomcat:tomcat-catalina
// TODO make a PR against github.com/apache/tomcat so CorsFilter is a separate package
// 1. CorsFilter with org.slf4j logger
// 2. Exclude StringManager translations
public final class CorsFilter extends GenericFilter {
    ...
    protected void handleSimpleCORS(final HttpServletRequest request,
        ...
        if (!(requestType == CorsFilter.CORSRequestType.SIMPLE ||
            ...
            throw new IllegalArgumentException(
                    String.format("Expects a HttpServletRequest object of type %s or %s",
    ...
    protected void handlePreflightCORS(final HttpServletRequest request,
        ...
        if (requestType != CORSRequestType.PRE_FLIGHT) {
            throw new IllegalArgumentException(String.format("Expects a HttpServletRequest object of type %s",
    ...
    protected static void decorateCORSProperties(
        ...
        if (corsRequestType == null) {
            throw new IllegalArgumentException(
                    "CORSRequestType object is null");
        }
        ...
        if (preflightMaxAge != null) {
            try {
                ...
                throw new ServletException(
                        "Unable to parse preflightMaxAge", e);
            }
        }
