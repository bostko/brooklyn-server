...
public interface CloudLocationConfig {
    ...
    ConfigKey<Class<? extends Predicate<HostAndPort>>> POLL_FOR_FIRST_REACHABLE_ADDRESS_PREDICATE_CLASS = ConfigKeys.newConfigKey(new TypeToken<Class<? extends Predicate<HostAndPort>>>(){},
            "pollForFirstReachableAddress.predicateClass",
            "Predicate<HostAndPort> class. Other keys " +
                    "prefixed with pollForFirstReachableAddress.predicateClass.<property> will be passed to the Map constructor of the Predicate<HostAndPort> implementation.",
