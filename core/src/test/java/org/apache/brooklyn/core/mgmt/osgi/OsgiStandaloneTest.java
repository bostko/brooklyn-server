...
public class OsgiStandaloneTest extends OsgiTestBase {
    ...
    public void testDuplicateBundle() throws Exception {
        MavenArtifact artifact = new MavenArtifact("org.apache.brooklyn", "brooklyn-api", "jar", "0.10.0-20160722.2343"); // BROOKLYN_VERSION
    ...
    public void testRemoteDuplicateBundle() throws Exception {
        helperDuplicateBundle(MavenRetriever.hostedUrl(new MavenArtifact("org.apache.brooklyn", "brooklyn-api", "jar", "0.10.0-20160722.2343"))); // BROOKLYN_VERSION
    }
